            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-gray-400">Add a new product to your catalog</p>
                    </div>
                    ...
                    <div class="bg-gray-700/50 rounded-lg p-6">
                        ...
                        <div class="mt-6">
                            ...
                            <input type="file" name="image" id="image" accept="image/*"
                                   class="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-yellow-400 file:text-black hover:file:bg-yellow-300 focus:ring-2 focus:ring-yellow-400 focus:border-transparent">
                            <p class="mt-1 text-sm text-gray-400">Upload a product image (JPEG, PNG, JPG, GIF, max 2MB)</p>
                            @error('image')
                                <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="bg-gray-700/50 rounded-lg p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="ingredients" id="ingredients" rows="3"
                                      class="w-full px-4 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
                                      placeholder="Hyaluronic Acid, Vitamin E, Retinol (comma separated)">{{ old('ingredients') }}</textarea>
