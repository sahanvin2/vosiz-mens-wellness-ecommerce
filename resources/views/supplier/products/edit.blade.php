                ...
                <div class="p-6 lg:p-8">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p class="text-gray-400 mt-1">Update your product information</p>
                        </div>
                    ...
                    <form action="{{ route('supplier.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="short_description" name="short_description" rows="2"
                                              ...
                                              class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">{{ old('short_description', $product->short_description) }}</textarea>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="description" name="description" rows="4" required
                                              ...
                                              class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">{{ old('description', $product->description) }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-900/30 rounded-lg p-6 border border-gray-700">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="compare_price" name="compare_price" value="{{ old('compare_price', $product->compare_price) }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="ingredients" name="ingredients" rows="3"
                                              ...
                                              class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">{{ old('ingredients', is_array($product->ingredients) ? implode(', ', $product->ingredients) : $product->ingredients) }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea id="benefits" name="benefits" rows="3"
                                              ...
                                              class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">{{ old('benefits', is_array($product->benefits) ? implode(', ', $product->benefits) : $product->benefits) }}</textarea>
                                </div>

                                <!-- Skin Type -->
                                <div>
                                    <label for="skin_type" class="block text-sm font-medium text-gray-300 mb-2">Skin Type</label>
                                    <input type="text" id="skin_type" name="skin_type" value="{{ old('skin_type', $product->skin_type) }}"
                        ...
                        <div class="bg-gray-900/30 rounded-lg p-6 border border-gray-700">
                            ...
                            <div class="mb-6">
                                <h4 class="text-md font-medium text-gray-300 mb-3">Current Images:</h4>
                            ...
                            <div>
                                <label for="images" class="block text-sm font-medium text-gray-300 mb-2">Upload New Images (Optional)</label>
                                ...
                                <p class="text-gray-400 text-sm mt-2">Select multiple images to replace current ones. Recommended size: 800x800px. Max file size: 2MB per image.</p>
                            </div>
                        </div>
